// ============================================================================
// ABOUT YOU -- your story, and the small number boxes under it.
// ============================================================================

export const about = {
  // The heading above your story.
  heading: "Behind the lens",

  // The short version, right under the heading. A few sentences in your own
  // words. Leave a blank line between paragraphs if you want two.
  ...
  // Both halves are yours -- the label can say anything you want.
  // KEEP the "stats: [" and "]" lines even when empty, or the site won't build.
  stats: [
  ],
};
